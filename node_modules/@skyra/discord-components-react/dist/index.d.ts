...
declare const DiscordThread: react.ForwardRefExoticComponent<JSX.DiscordThread & Omit<react.HTMLAttributes<HTMLDiscordThreadElement>, "style"> & StyleReactProps & react.RefAttributes<HTMLDiscordThreadElement>>;
declare const DiscordThreadMessage: react.ForwardRefExoticComponent<JSX.DiscordThreadMessage & Omit<react.HTMLAttributes<HTMLDiscordThreadMessageElement>, "style"> & StyleReactProps & react.RefAttributes<HTMLDiscordThreadMessageElement>>;

export { DiscordActionRow, DiscordAttachment, DiscordAttachments, DiscordButton, DiscordCommand, DiscordEmbed, DiscordEmbedField, DiscordEmbedFields, DiscordInvite, DiscordMention, DiscordMessage, DiscordMessages, DiscordReaction, DiscordReactions, DiscordReply, DiscordSystemMessage, DiscordTenorVideo, DiscordThread, DiscordThreadMessage };
