...
export class DiscordThread {
  ...
  render() {
    return (h(Host, { class: "discord-thread" },
      h("div", { class: "discord-thread-top" },
        h("span", { class: "discord-thread-name" }, this.name),
        h("span", { class: "discord-thread-cta", "aria-hidden": "true" },
          this.cta,
          " \u203A")),
      h("span", { class: "discord-thread-bottom" },
        h("slot", null))));
  }
