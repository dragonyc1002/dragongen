...
export class DiscordThreadMessage {
  ...
  render() {
    ...
    return (h(Host, { class: "discord-thread-message" },
      h("img", { src: profile.avatar, class: "discord-thread-message-avatar", alt: profile.author }),
      h(Fragment, null,
      ...
      h("span", { class: "discord-thread-message-username", style: { color: profile.roleColor } }, profile.author),
      h("div", { class: "discord-thread-message-content" },
        h("slot", null),
        this.edited ? h("span", { class: "discord-message-edited" }, "(edited)") : ''),
      h("span", { class: "discord-thread-message-timestamp" }, this.relativeTimestamp)));
  }
